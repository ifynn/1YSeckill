...
public class Sheet extends Dialog {
    ...
    public Sheet(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected Sheet(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        private IPrompter.OnItemClickListener onItemClickListener;
        ...
        public Builder setSimpleItems(List<String> items) {
            if (items != null && !items.isEmpty()) {
                Iterator<String> i = items.iterator();
                while (i.hasNext()) {
                    String item = i.next();
                    SheetItem sheetItem = new SheetItem(item);
        ...
        public Builder addItem(String itemText, @ColorInt int color) {
            if (itemText != null) {
        ...
        public Builder setOnItemClickListener(IPrompter.OnItemClickListener onItemClickListener) {
        ...
        public Sheet create() {
            if (sheet == null) {
                sheet = new Sheet(mContext, theme);
            }
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (onItemClickListener != null) {
                    viewHolder.tvItem.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            onItemClickListener.onItemClick(sheet, viewHolder.tvItem, position);
                        }
                    });
                }
